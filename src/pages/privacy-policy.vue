<template>
  <div>
    <div class="subsection">
      <h1>ApeSwap OU Privacy&nbsp;Policy</h1>
    ...
    <div class="subsection">
      ...
      <p>
        ...
        accessible to ApeSwap and its vendor(s).
      </p>
    </div>
    <div class="subsection">
      ...
      <ul>
        <li>Ensure proper functioning of ApeSwap and the UI;</li>
        <li>
        ...
        <li>
          ...
          rights and property of ApeSwap and others;
        </li>
    ...
    <div class="subsection">
      ...
      <p>
        ApeSwap is headquartered in Estonia. Therefore, we and our service
