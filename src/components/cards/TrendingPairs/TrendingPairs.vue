  ...
  >
    <div class="trending-pairs">
      <div
        ...
        class="flex justify-between p-3 lg:border-b dark:border-white4-dark"
      >
        <h6>{{ $t('trendingPairs') }}</h6>
      </div>
      <div class="px-1 lg:p-3 flex flex-wrap gap-3">
        <button
          class="py-1 px-2 bg-transparent hover:bg-blue-500 hover:text-primary-bright text-sm rounded-lg border dark:border-white3-dark font-medium lg:font-medium transition-colors"
