...
export type UserStakingDataResponse = {
  ...
  refetchUserStakingData: Ref<(options?: RefetchOptions) => undefined>;
  // NOTE: A|S Update: refetchUserStakingData disabled
